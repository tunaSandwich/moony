        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-white/80 text-sm">
              Budget Pal - How We Protect Your Information
            </p>
          </div>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6 text-white/90 space-y-6 max-h-96 overflow-y-auto">
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed mb-3">
                Budget Pal collects the following types of information to provide our services:
              </p>
            ...
            <section className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-4">
              ...
              <p className="text-sm leading-relaxed mt-2">
                ...
                the Budget Pal services you have explicitly requested, such as spending notifications and budget alerts.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                Budget Pal is not intended for use by children under 18. We do not knowingly collect personal information from children under 18. 
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                ...
                We will notify you of significant changes via email or SMS. Your continued use of Budget Pal after changes indicates acceptance of the updated policy.
              </p>
            </section>
