        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-white/80 text-sm">
              Budget Pal - Daily Spending Notifications
            </p>
          </div>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6 text-white/90 space-y-6 max-h-96 overflow-y-auto">
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                Budget Pal provides automated daily spending notifications and monthly budget tracking services via SMS messaging. 
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed mb-3">
                By using Budget Pal's SMS services, you agree to receive:
              </p>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                Budget Pal uses Plaid to securely connect to your bank account. We only access transaction data necessary to provide spending analysis and budget tracking. 
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                Budget Pal is provided "as is" without warranties. We strive for 99% uptime but cannot guarantee uninterrupted service. 
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                You may terminate your Budget Pal account at any time. Upon termination, we will stop sending SMS messages and delete your financial data within 30 days, 
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                ...
                Continued use of Budget Pal after changes indicates acceptance of the updated terms.
              </p>
            </section>
